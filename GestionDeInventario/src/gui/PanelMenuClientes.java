...
public class PanelMenuClientes extends javax.swing.JPanel {
    ...
    public PanelMenuClientes(FramePrincipal fp) throws SQLException {
        this.fp = fp;
        
        initComponents();
        
        mostrarClientes(FunCliente.listarClientes());
    }
    ...
    private void initComponents() {
        ...
        tablaClientes.setBackground(Color.decode(Colors.TEXTO_FONDO.getColor()));
        tablaClientes.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        tablaClientes.setForeground(Color.decode(Colors.TEXTO.getColor()));
        ...
        tablaClientes.setGridColor(Color.decode(Colors.FONDO.getColor()));
        tablaClientes.setIntercellSpacing(new java.awt.Dimension(5, 0));
...
//Tabla Menu Cliente    
    private void tablaClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaClientesMouseClicked
        try {
            ...
            int pos = tablaClientes.getSelectedRow();
...
//Botones Agregar Cliente
    private void btnAceptarAgrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarAgrActionPerformed
        try {
            String ok = FunCliente.agregarCliente(this.textNombre.getText(), this.textEdad.getText(), this.textDireccion.getText(), this.textTelefono.getText(), this.textEmail.getText());
            if(ok != null){
...
//Botones Modificar Cliente    
    private void btnAceptarModActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarModActionPerformed
        try {
            String ok = FunCliente.modificarCliente(id_cliente, this.textNombreMod.getText(), this.textEdadMod.getText(), this.textDireccionMod.getText(), this.textTelefonoMod.getText(), this.textEmailMod.getText());
            if(ok != null){
